...
const services = [
  ...
  { slug: "fascias-and-soffits", name: "Fascias & Soffits", icon: "▰", short: "Full uPVC fascia and soffit replacement, removing rotten timber rather than simply capping over it." },
...
const galleryImages = [
  { file: "black-gutter-soffit-fascia-installation.webp", width: 750, height: 1000, alt: "Black guttering with replacement fascia and soffit installed by Gutterworx", caption: "Full fascia, soffit and gutter replacement" },
  { file: "black-guttering-facia-soffit-brick-house.webp", width: 750, height: 1000, alt: "Black guttering, fascia and soffit fitted to a brick house", caption: "Black roofline installation" },
  { file: "black-guttering-stone-wall.webp", width: 750, height: 1000, alt: "Black guttering installed along a Yorkshire stone property", caption: "Stone property roofline" },
  { file: "seamless-gutter-installation-van.webp", width: 750, height: 1000, alt: "Long seamless gutter being formed beside the Gutterworx van", caption: "Seamless gutter formed on site" },
  { file: "man-working-on-black-aluminum-gutter-on-street.webp", width: 750, height: 1000, alt: "Gutterworx installer working on a long black aluminium gutter", caption: "Made-to-measure aluminium gutter" },
  { file: "black-plastic-rain-gutter-downspout-house.webp", width: 1000, height: 563, alt: "Completed black rainwater gutter and downpipe system on a house", caption: "Gutter and downpipe installation" },
  { file: "black-pvc-guttering-brick-house.webp", width: 500, height: 333, alt: "Black guttering and white soffit detail on a brick house", caption: "Clean roofline detailing" },
  { file: "rainwater-gutter-system-slate-roof.webp", width: 750, height: 1000, alt: "Rainwater gutter system fitted beneath a slate roof", caption: "Slate roof gutter system" },
  { file: "two-men-ladders-stone-house-roof-work.webp", width: 750, height: 1000, alt: "Two Gutterworx installers carrying out roofline work on a stone house", caption: "Stone house roofline work" },
  { file: "white-van-gutter-machine-tools.webp", width: 651, height: 1000, alt: "Gutter forming machine and tools beside the Gutterworx van", caption: "Mobile gutter forming equipment" },
  { file: "black-guttering-wooden-shed.webp", width: 1000, height: 750, alt: "Black guttering fitted to a timber outbuilding", caption: "Timber outbuilding guttering" },
  { file: "black-pvc-downpipe-wooden-shed.webp", width: 750, height: 1000, alt: "Black downpipe installed on a wooden outbuilding", caption: "Downpipe installation" },
  { file: "black-pvc-guttering-shed.webp", width: 750, height: 1000, alt: "Black gutter and downpipe system fitted to a shed", caption: "Complete outbuilding rainwater system" },
  { file: "black-plastic-guttering-house-exterior.webp", width: 750, height: 1000, alt: "Black guttering fitted around the corner of a house", caption: "Residential gutter replacement" },
  { file: "brick-terraced-house-front.webp", width: 750, height: 1000, alt: "Brick terraced house following Gutterworx roofline work", caption: "Terraced property project" },
  { file: "house-drainage-installation.webp", width: 750, height: 1000, alt: "House drainage and rainwater installation in progress", caption: "Rainwater drainage installation" },
  { file: "house-extension-construction-site.webp", width: 750, height: 1000, alt: "House extension roofline project under construction", caption: "Extension roofline project" }
];
...
<head>
  ...
  <link rel="stylesheet" href="${prefix}assets/css/site.css?v=5">
...
function floating() {
  ...
  <a class="float-btn" href="tel:${phone}" aria-label="Call Gutterworx"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.79 19.79 0 0 1 2.12 4.18 2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.13.96.36 1.9.69 2.8a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.91.33 1.85.56 2.81.69A2 2 0 0 1 22 16.92z"/></svg></a>
  <a class="float-btn whatsapp" href="https://wa.me/${whatsapp}?text=Hi%20Gutterworx%2C%20I%27d%20like%20a%20quote." aria-label="WhatsApp Gutterworx" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.075-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.095 3.2 5.076 4.487.709.306 1.262.489 1.694.626.712.226 1.36.194 1.872.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.981.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.002-5.45 4.436-9.884 9.892-9.884a9.82 9.82 0 0 1 7.021 2.91 9.79 9.79 0 0 1 2.9 7.014c-.003 5.45-4.437 9.884-9.929 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.304-1.654a11.88 11.88 0 0 0 5.684 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.82 11.82 0 0 0-3.48-8.413z"/></svg></a>
</aside>`;
}
...
<script src="${prefix}assets/js/site.js?v=2" defer></script>
</body>
</html>`;
}
...
function galleryFigures(prefix, images = galleryImages) {
  return images.map(image => `<figure><img src="${prefix}assets/images/${image.file}" alt="${esc(image.alt)}" width="${image.width}" height="${image.height}" loading="lazy"><figcaption>${esc(image.caption)}</figcaption></figure>`).join("");
}

function quoteForm() {
  return `<form class="form-shell" name="quote-request" method="POST" action="/thank-you/" enctype="multipart/form-data" data-netlify="true" netlify-honeypot="bot-field" data-quote-form>
  ...
  <div class="form-grid">
    ...
    <fieldset class="photo-upload field full"><legend class="fieldset-title">Project photos <span>(optional)</span></legend><p class="field-help">Add up to three photos to help us understand the work. JPG, PNG, WebP or another image format; 7 MB maximum combined.</p><div class="photo-grid"><label>Photo 1<input name="project_photo_1" type="file" accept="image/*" data-project-photo></label><label>Photo 2<input name="project_photo_2" type="file" accept="image/*" data-project-photo></label><label>Photo 3<input name="project_photo_3" type="file" accept="image/*" data-project-photo></label></div><p class="upload-error" data-upload-error role="alert" hidden></p></fieldset>
  </div>
...
write("index.html", doc({
  ...
  <section class="section"><div class="container split"><div><p class="eyebrow">Specialist roofline work</p><h2>Built to manage <span class="red">Yorkshire weather.</span></h2><hr class="rule"><p class="lead">Seamless guttering is formed in continuous lengths at your property, helping remove the joints that commonly become weak points in traditional sectional systems.</p><p class="muted">Gutterworx focuses first on guttering, fascias and soffits. Where the surrounding roof needs attention, we can also quote for practical repair work so the whole roofline performs as it should.</p><ul class="checks"><li>Aluminium seamless systems</li><li>Full uPVC fascia and soffit replacement</li><li>Roofline repairs</li><li>Trade cut and drop</li></ul><a class="btn" href="about/">About Gutterworx</a></div><div class="image-card"><img src="assets/images/black-guttering-stone-wall.webp" alt="Black guttering installed on a Yorkshire stone property" width="750" height="1000" loading="lazy"><div class="image-label">Continuous gutter runs are formed and measured for a clean, accurate fit.</div></div></div></section>
